    ...
    return (
        <aside className="w-64 border-r border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex-col hidden md:flex">
            ...
            <div className="p-4 border-t border-slate-200 dark:border-zinc-800">
                <a href="#" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-red-50 dark:hover:bg-red-950/30 text-slate-600 dark:text-zinc-400 hover:text-red-600 dark:hover:text-red-400 transition-colors">
                    <LogOut size={18} />
                    Cerrar sesión
                </a>
            </div>
